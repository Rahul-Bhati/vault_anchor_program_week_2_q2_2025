...
declare_id!("6kyasRjue1maqjAyHmp1Mn15Tjiz5efdH211S5QbLyu3");
...
impl<'info> Payment<'info>{
    pub fn deposit(&mut self, amount: u64) -> Result<()> {
        // transfer krna h funds ko user se wallet me to sys program ka use krke jo ki khud program h or to dusre program ka use krna CPI(cross program invocation) me aata h
        
        // which program we are interecting
        ...
        // there are two method to sign the trasaction new and new_signer in cpi_context
        // new -> when we sign with wallet other wise new_signer when we sign with pda
